import { FormProvider, RHFAutocompleteAsync, RHFRadioGroup, RHFTextField } from "@/src/components/rhf";
...
export const Schema = () =>
    Yup.object().shape({
        ...
        individual_or_company: Yup.string().required('Individual or company selection is required'),
        industry_id: Yup.object()
        .nullable()
                            ...
                            {activeStep === 0 && (
                                <>
                                    <Grid item xs={12} md={6}>
                                        <RHFTextField name="business_name" size="small" outerLabel="Business Name" />
                                    </Grid>
                                    <Grid item xs={12} md={6} />
                                    <Grid item xs={12} md={6}>
                                        <RHFUploadSingleFileWithPreview name="business_logo" outerLabel="Business Logo" />
                                    </Grid>
                                    <Grid item xs={12} md={6} />
                                    <Grid item xs={12} md={6}>
                                        <RHFTextField name="business_email" size="small" outerLabel="Businessn Email" />
                                    </Grid>
                                    <Grid item xs={12} md={6} />
                                    <Grid item xs={12} md={6}>
                                        <RHFTextField name="contact_num" outerLabel="Contact No" size="small" />
                                    </Grid>
                                    <Grid item xs={12} md={6} />
                                    <Grid item xs={12} md={6}>
                                        <RHFTextField name="address" outerLabel="Address" size="small" />
                                    </Grid>
                                    <Grid item xs={12} md={6} />
                                    <Grid item xs={12} md={6}>
