                            ...
                            {activeStep === 0 && (
                                <>
                                    <Grid item xs={12} md={6}>
                                        <RHFTextField name="businessName" size="small" outerLabel="Business Name" />
                                    </Grid>
                                    <Grid item xs={12} md={6} />
                                    <Grid item xs={12} md={6}>
                                        <RHFUploadSingleFileWithPreview name="businessLogo" outerLabel="Business Logo" />
                                    </Grid>
                                    <Grid item xs={12} md={6} />
                                    <Grid item xs={12} md={6}>
                                        <RHFTextField name="busninessEmail" size="small" outerLabel="Businessn Email" />
                                    </Grid>
                                    <Grid item xs={12} md={6} />
                                    <Grid item xs={12} md={6}>
