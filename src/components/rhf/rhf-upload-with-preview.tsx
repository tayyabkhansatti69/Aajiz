...
import { UploadSingleFileWithPreviewFile } from "../upload/upload-signle-file-withpreview";

//  icons
// import { AttachFileIcon } from "common/assets";

export function RHFUploadSingleFileWithPreviewWithoutValidation({
  name,
  outerLabel,
  supportedFormats,
  ...other
      ...
      render={({ field, fieldState: { error } }) => {
        ...
        return (
          <Stack gap="0.6rem">
            ...
            <UploadSingleFileWithPreviewFile
              file={field.value}
              error={hasError}
...
export function RHFUploadSingleFileWithoutPreviewWithoutValidation({
  name,
  label = "Upload File",
  accept,
  disabled,
